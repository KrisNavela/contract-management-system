...
const breadcrumbs: BreadcrumbItem[] = [
    { title: 'Initial Approval Queue', href: '/queue/initial-approver' },
];
...
export default function InitialApproverQueue({ contracts }: Props) {
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Initial Approval Queue" />
            ...
            <div className="mx-auto w-full max-w-screen-xl px-4 space-y-6">
                ...
                <div>
                    ...
                    <p className="text-sm text-gray-600">
                        Contracts awaiting initial approval
                    </p>
                </div>
