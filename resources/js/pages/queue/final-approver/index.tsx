...
const breadcrumbs: BreadcrumbItem[] = [
    { title: 'Final Approval Queue', href: '/queue/final-approver' },
];
...
export default function FinalApproverQueue({ contracts }: Props) {
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Final Approval Queue" />
            ...
            <div className="mx-auto w-full max-w-screen-xl px-4 space-y-6">
                ...
                <div>
                    ...
                    <p className="text-sm text-gray-600">
                        Contracts awaiting final approval
                    </p>
                </div>
                        ...
                        <tbody className="divide-y">
                            {contracts.length === 0 && (
                                <tr>
                                    ...
                                    >
                                        No contracts pending final approval.
                                    </td>
                                </tr>
                            )}
