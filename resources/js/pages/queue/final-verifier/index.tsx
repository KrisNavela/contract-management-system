...
const breadcrumbs: BreadcrumbItem[] = [
    { title: 'Final Verifier Queue', href: '/queue/final-verifier' },
];
...
export default function FinalVerifierQueue({ contracts }: Props) {
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Final Verifier Queue" />
            ...
            <div className="mx-auto w-full max-w-screen-xl px-4 space-y-6">
                ...
                <div>
                    ...
                    <p className="text-sm text-gray-600">
                        Contracts awaiting final verification
                    </p>
                </div>
                        ...
                        <tbody className="divide-y">
                            {contracts.length === 0 && (
                                <tr>
                                    ...
                                    >
                                        No contracts pending final verification.
                                    </td>
                                </tr>
                            )}
